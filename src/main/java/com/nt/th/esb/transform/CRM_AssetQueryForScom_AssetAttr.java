...
public class CRM_AssetQueryForScom_AssetAttr {
    ...
    private CRM_AssetQueryForScom_InstAddr InstAddr;
	...
	public CRM_AssetQueryForScom_InstAddr getInstAddr() {
		return InstAddr;
	}

	public void setInstAddr(CRM_AssetQueryForScom_InstAddr instAddr) {
		InstAddr = instAddr;
	}
